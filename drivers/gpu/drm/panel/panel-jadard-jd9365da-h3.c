...
static const struct jadard_init_cmd radxa_display_8hd_a_init_cmds[] = {
	{ .data = {0xE0,0x00 } },
	{ .data = {0xE1,0x93 } },
	{ .data = {0xE2,0x65 } },
	{ .data = {0xE3,0xF8 } },
...
static const struct jadard_panel_desc radxa_display_8hd_a_desc = {
	.mode = {
		.clock		= 70000,
	...
	.init_cmds = radxa_display_8hd_a_init_cmds,
	.num_init_cmds = ARRAY_SIZE(radxa_display_8hd_a_init_cmds),
};

static const struct jadard_init_cmd radxa_display_10hd_a_init_cmds[] = {
	{ .data = { 0xE0, 0x00 } },
	{ .data = { 0xE1, 0x93 } },
	{ .data = { 0xE2, 0x65 } },
	{ .data = { 0xE3, 0xF8 } },
...
static const struct jadard_panel_desc radxa_display_10hd_a_desc = {
	.mode = {
		.clock		= 70000,
	...
	.lanes = 4,
	.format = MIPI_DSI_FMT_RGB888,
	.init_cmds = radxa_display_10hd_a_init_cmds,
	.num_init_cmds = ARRAY_SIZE(radxa_display_10hd_a_init_cmds),
};

static const struct jadard_panel_desc radxa_display_10hd_n40a_desc = {
	.mode = {
		.clock		= 160000,
...
static int jadard_dsi_probe(struct mipi_dsi_device *dsi)
{
	...
	jadard->reset = devm_gpiod_get(dev, "reset", GPIOD_ASIS);
...
static const struct of_device_id jadard_of_match[] = {
	{
		...
		.data = &radxa_display_10hd_a_desc
	},
	{
		.compatible = "radxa,display-10hd-a",
		.data = &radxa_display_10hd_a_desc
	},
	{
		.compatible = "radxa,display-8hd-a",
		.data = &radxa_display_8hd_a_desc
	},
	{
		.compatible = "radxa,display-10hd-N40A",
		.data = &radxa_display_10hd_n40a_desc
	},
	{ /* sentinel */ }
};
