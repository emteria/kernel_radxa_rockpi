...
*****************************************************************************/
extern struct fts_upgrade *fwupgrade_r;
extern struct upgrade_func upgrade_func_ft8006m_r;
...
int fts_flash_write_buf_r(struct i2c_client *client, u32 saddr, u8 *buf, u32 len, u32 delay);
