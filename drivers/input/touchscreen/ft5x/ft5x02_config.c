...
*
*/
int ft5x02_i2c_Read2(struct i2c_client *client,  char * writebuf, int writelen,
...
*write data by i2c
*/
int ft5x02_i2c_Write2(struct i2c_client *client, char *writebuf, int writelen)
{
	int ret;
...
int ft5x02_write_reg(struct i2c_client * client, u8 regaddr, u8 regvalue)
{
	...
	return ft5x02_i2c_Write2(client, buf, sizeof(buf));
}

int ft5x02_read_reg(struct i2c_client * client, u8 regaddr, u8 * regvalue)
{
	return ft5x02_i2c_Read2(client, &regaddr, 1, regvalue, 1);
}
