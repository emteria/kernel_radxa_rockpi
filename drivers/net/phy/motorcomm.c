...
//static int yt8511_led_init(struct phy_device *phydev)
/*int yt8511_led_init(struct mii_bus *bus, int phy_id)
{
	int ret;
	//int val;
	//int mask;

	ret = ytphy_mii_wr_ext(bus, phy_id, 0xb9, 0x24);
...
static int yt8511_config_init(struct phy_device *phydev)
{
	...
	printk("###########rocky############# yt8512_led_init \n");
	//ret = yt8511_led_init(phydev->bus, phydev->addr);
