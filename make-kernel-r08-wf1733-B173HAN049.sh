...
cp drivers/gpu/drm/bridge/analogix/analogix_dp_core.c-B173HAN049 drivers/gpu/drm/bridge/analogix/analogix_dp_core.c && \
echo "end patch"
make ARCH=arm64 r08_defconfig android-11.config && \
cp logo-0.bmp logo.bmp && \
make ARCH=arm64 BOOT_IMG=../rockdev/Image-$TARGET_PRODUCT/boot.img rk3399-evb-ind-lpddr4-android-avb-r08-wf1733-B173HAN049.img -j24 && \
...
cp drivers/gpu/drm/bridge/analogix/analogix_dp_core.c-normal drivers/gpu/drm/bridge/analogix/analogix_dp_core.c
