...
cp drivers/gpu/drm/bridge/analogix/analogix_dp_core.c-n4c-ns0 drivers/gpu/drm/bridge/analogix/analogix_dp_core.c && \
echo "end patch"
make ARCH=arm64 r08_defconfig android-11.config && \
cp logo-0.bmp logo.bmp && \
make ARCH=arm64 BOOT_IMG=../rockdev/Image-$TARGET_PRODUCT/boot.img rk3399-evb-ind-lpddr4-android-avb-r08-wf1733-ns0.img -j24 && \
